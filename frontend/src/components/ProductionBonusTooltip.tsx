      ...
      <div className="invisible group-hover:visible absolute z-10 w-80 p-3 bg-[#1a1a1a] text-white rounded-lg shadow-lg bottom-full left-1/2 transform -translate-x-1/2 mb-2">
        ...
        {bonus.country && (
          <div className="flex items-start gap-2 mb-2 text-sm">
            ...
            <div className="flex-1">
              <span className="text-green-400 font-semibold">+{bonus.country.bonus}%</span>
              <span className="text-gray-400"> from </span>
              <span className="text-gray-400">{bonus.country.countryName} strategic resources production bonus</span>
            </div>
          </div>
        )}
        ...
        {bonus.party && (
          <div className="flex items-start gap-2 text-sm">
            ...
            <div className="flex-1">
              <span className="text-green-400 font-semibold">+{bonus.party.bonus}%</span>
              <span className="text-gray-400"> from </span>
              <span className="text-gray-400">{bonus.party.ethicName} ethics specialization bonus</span>
            </div>
          </div>
        )}
