      ...
      <div className="bg-gray-800 rounded-lg shadow p-6 mb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-xl font-bold text-white"><CurrencyValue value={company.totalDailyWage || 0} /></p>
          </div>
          <div>
                ...
                <tbody>
                  {workers.map((worker: any, index: number) => (
                    <tr key={worker.workerId} className="border-b border-gray-700 hover:bg-gray-700/50">
                      ...
                      <td className="text-right py-2 px-2 text-white"><CurrencyValue value={worker.wage} /></td>
