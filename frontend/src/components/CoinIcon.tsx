/**
 * CoinIcon - Inline SVG coin icon matching the in-game currency symbol.
 * Use inline wherever a currency symbol is needed.
 */
export default function CoinIcon() {
  return (
    <svg
      ...
      style={{ width: '1em', overflow: 'visible', height: '1em', fontSize: '120%', filter: 'drop-shadow(black 1px 1px 0px)', display: 'inline', verticalAlign: 'middle' }}
    >
