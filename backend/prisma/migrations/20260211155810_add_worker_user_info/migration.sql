...
INSERT INTO "new_Worker" ("companyId", "createdAt", "id", "maxEnergy", "production", "updatedAt", "userId", "wage", "workerId") SELECT "companyId", "createdAt", "id", "maxEnergy", "production", "updatedAt", "userId", "wage", "workerId" FROM "Worker";
DROP TABLE "Worker";
